...
namespace SQLUygulama.Controllers
{
    ...
    public class PokemonController : Controller
    {
        ...
        public PokemonController(IPokemonRepository pokemonRepository,
            ...
            IMapper mapper)  //Repository'yi çağırdık.GetPokemons'u kullanabilelim diye.
        ...
        {
            var pokemons = _mapper.Map<List<PokemonDto>>(_pokemonRepository.GetPokemons());    //Modelstate değerinin aynı türde girilip girilmediğini kontrol eder.
